...
##################################################################################################################
    ...
    test_feat_file = os.listdir(test_feat_folder) #used listdir for pathof feat in test file
    test_feat_path = [(test_feat_folder + filename) for filename in test_feat_file] # wgen filename extension
    test_video_IDs = [filename[:-4] for filename in test_feat_file] # remove filename extension .avi
